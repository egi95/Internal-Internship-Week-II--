...
void main() {
  // Test 1: Shembull: [1,2,3,4,5,6] → cift: [2,4,6], tek: [1,3,5]
  List<int> numrat1 = [1, 2, 3, 4, 5, 6];
  Map<String, List<int>> rezultati1 = ndaj(numrat1);
  print("Input: $numrat1");
  print("Çift: ${rezultati1['cift']}");
  ...
  print("Input: $numrat5");
  print("Çift: ${rezultati5['cift']}");
  print("Tek: ${rezultati5['tek']}");
}
